        ...
        <div class="block block-rounded">
          <div class="block-header block-header-default"><h3 class="block-title v2board-trade-no">订单信息</h3>
            <div class="block-options">
              <button type="button" class="btn btn-primary btn-sm btn-danger btn-rounded px-3" @click="closeOrder">
                关闭订单
              </button>
            </div>
          </div>
        ...
        <div class="block block-rounded js-appear-enabled">
          ...
          <div class="block-content p-0">
            <div class="v2board-select active border-primary">
              ...
              <div style="flex: 1 1 0%; text-align: right;"><img height="30"
                                                                 src="https://cdnjs.cloudflare.com/ajax/libs/simple-icons/3.2.0/alipay.svg">
              </div>
            </div>
          </div>
        </div>
    ...
    <div>
      <div class="ant-modal-root">
        ...
        <div tabindex="-1" class="ant-modal-wrap ant-modal-centered" role="dialog"
          ...
          <div role="document" class="ant-modal v2board-payment-qrcode" style="width: 300px;" v-clickOutSide="closeQr">
