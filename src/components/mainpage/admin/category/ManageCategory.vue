                        ...
                        <table class="">
                          ...
                          <tr>
                            <th class=""><span class="ant-table-header-column"><div><span
                                class="ant-table-column-title">ID</span><span class="ant-table-column-sorter"></span></div></span>
                            </th>
                            <th class=""><span class="ant-table-header-column"><div><span
                                class="ant-table-column-title">类别名称</span><span
                                class="ant-table-column-sorter"></span></div></span></th>
                            <th class=""><span class="ant-table-header-column"><div><span
                                class="ant-table-column-title">商品数量</span><span
                                class="ant-table-column-sorter"></span></div></span></th>
                            <th class="ant-table-align-right ant-table-row-cell-last" style="text-align: right;"><span
                                class="ant-table-header-column"><div><span
                                class="ant-table-column-title">操作</span><span class="ant-table-column-sorter"></span></div></span>
                            </th>
                          </tr>
                          </thead>
<!--                            <AdminCategoryList :data="data" v-if="!isLoading"/>-->
                          <tbody class="ant-table-tbody">
                            <AdminCategoryItem v-if="!isLoading" :pageDict="pageDict" :dictKey="dictKey"
                                               v-for="cate in this.data"
                                               :key="cate.id"
                                               :cate="cate"/>
                          </tbody>
                        </table>
...
<script>
import AdminCategoryItem from "@/components/mainpage/admin/category/AdminCategoryItem";
