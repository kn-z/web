<template>
  <tr :class=style @mouseover="changeFocus" @mouseleave="clearFocus" data-row-key="0">
    ...
    <td class="ant-table-column-has-actions ant-table-column-has-filters ant-table-row-cell-break-word"><span><span class="ant-tag ant-tag-has-color" style="background-color: rgb(203, 44, 18);">{{goods.name}}</span></span></td>
    <td class="">
      <button @click="changeStatus" type="button" role="switch" aria-checked="false" :class="status ? 'ant-switch-small ant-switch ant-switch-checked':'ant-switch-small ant-switch'"><span
