                ...
                <div :class="isLoading ? 'block block-rounded block-mode-loading':'block border-bottom'">
                    <div class="bg-white">
                        <div class="v2board-table-action" style="padding: 15px;">
                            <button @click="add" type="button" class="ant-btn ant-dropdown-trigger"><i
                                    aria-label="图标: plus"
                            ...
                            <input placeholder="输入任意关键字搜索" class="ant-input ml-2" type="text" value=""
                                   style="width: 200px;">
                            <button type="button" class="ant-btn ant-btn-primary" style="float: right;">
                                <span>编辑排序</span></button>
                        </div>
                                                ...
                                                <div class="ant-table-scroll">
                                                    <div tabindex="-1" class="ant-table-body"
                                                        ...
                                                        <table class="ant-table-fixed" style="width: 1300px;">
                                                            ...
                                                            <AdminCamiItem v-for="item in this.data"
                                                                           :key="item.id"
                                                                           :item="item"/>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <div class="ant-table-body-outer">
                                                        <div class="ant-table-body-inner">
                                                            <table class="ant-table-fixed">
                                                                ...
                                                                <tbody class="ant-table-tbody">
                                                                <AdminCamiSetItem :pageDict="pageDict"
                                                                                  :dictKey="dictKey"
