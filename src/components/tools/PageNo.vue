<template>
    <ul class="ant-pagination ant-table-pagination mini" unselectable="unselectable">
        <li @click=jumpPage(-1) title="上一页"
            :class="flag<=1 ? 'ant-pagination-disabled ant-pagination-prev' : 'ant-pagination-prev'"
            :aria-disabled="flag<=1"><a
        ...
        <li @click=jumpPage(1) title="下一页" tabindex="0"
            :class="flag>=fin ? 'ant-pagination-disabled ant-pagination-prev' : 'ant-pagination-prev'"
            :aria-disabled="flag>=fin"><a
