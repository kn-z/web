    ...
    <div>
      <div>
        ...
        <div class="form-group">
              ...
              <div  @click="setSelectorPos" ref="selector" :class="selected ? 'ant-select ant-select-open ant-select-focused ant-select-enabled form-group' : 'ant-select ant-select-enabled form-group'" style="width: 100%;">
                <div class="ant-select-selection ant-select-selection--single" role="combobox" aria-autocomplete="list" aria-haspopup="true"
                  ...
                  <div class="ant-select-selection__rendered">
                    <div class="ant-select-selection-selected-value" title="无" style="display: block; opacity: 1;">{{getName(goods.cateId)}}</div>
                  </div>
          ...
          <div>
            <div class="form-group"><label for="example-text-input-alt">图片url</label><input placeholder="请输入图片链接"
                                                                                              type="text" class="ant-input"
                                                                                              v-model=goods.image
                                                                                              ></div></div>
        </div>
        <div class="form-group"><label for="example-text-input-alt">商品描述</label>
          <div><textarea rows="4" placeholder="请在这里记录.." class="ant-input" v-model=goods.content></textarea></div>
        </div>
      </div>
